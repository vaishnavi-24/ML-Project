...
#
lbl = tk.Label(root, text="Alzheimer Disease detection", font=('times', 35,' bold '), width=70,height=2,bg="Red3",fg="white")
lbl.place(x=0, y=0)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='F:/Alzheimer_Disease 100% Code', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
