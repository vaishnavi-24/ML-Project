...
window = tk.Tk()
window.geometry("1400x1300+200+50")
...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="#f7f414", fg="black")
l1.place(x=190, y=50)
...
btn = tk.Button(window, text="Register", bg="#f7f414",font=("",20),fg="black", width=9, height=1, command=insert)
